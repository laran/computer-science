...
public class TraverseTest {
	...
	public void shouldProperlyTraversePreOrder() {
		...
		assertThat(Traverse.preOrder(null, node -> {
			return false;
		}), is(nullValue()));
	}
	...
	public void shouldProperlyTraverseInOrder() {
		...
		// ensure that null values are handled properly
		assertThat(Traverse.inOrder(null, node -> {
			return false;
		}), is(nullValue()));
	}
	...
	public void shouldProperlyTraversePostOrder() {
		...
		// ensure that null values are handled properly
		assertThat(Traverse.postOrder(null, node -> {
			return false;
		}), is(nullValue()));
	}
	...
	public void shouldProperlyTraverseLevelOrder() {
		...
		// ensure that null values are handled properly
		assertThat(Traverse.levelOrder(null, node -> {
			return false;
		}), is(nullValue()));
	}
